...
const Banner = () => {
  const {
    ...
    seconds,
    isRunning,
  } = useTimer({ expiryTimestamp: new Date('7 April 2023 15:07:36 GMT+0200 (Central European Summer Time)'), onExpire: () => console.warn('onExpire called') });
      ...
      <div className="container">
        <div className={styles.content}>
          <div className={styles.textWrapper}>
            <p className={styles.text}>Tickets price increaseing in</p>
